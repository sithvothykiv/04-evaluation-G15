...
def llm_structured(client, instructions, user_prompt, output_type, model="qwen-max"):
    json_instructions = instructions + f"\n\nCRITICAL: Output ONLY valid JSON matching this exact schema, with no markdown formatting or extra text:\n{output_type.schema_json()}"
    ...
    parsed_output = output_type.model_validate_json(raw_content)
